  ...
  <body>
    ...
    <div class="container">   
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-info" data-dismiss="show.bs.modal" onClick="parent.location='tela_cadastro_documento.php'" >Close</button>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body ">
                    <form action="controlador.php?acao=inserir&tipo=doc" method="post" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Nome do arquivo</label>
                            <div class="col-sm-9">
                                <input name="nome_documento" type="text" class="form-control" placeholder="Nome"> 
                            </div>
                            <label class="col-sm-3 col-form-label mt-2">Pertece a: </label>
                            <div class="col-sm-9 mt-2">
                            <select name="nome_funcionario" class="form-select form-control" aria-label="Default select example">
                              <?php
                                require_once "cadastro_usuarios.php";
                                
                                $conexao = new Conexao();

                                $CadastrarUsuario = new CadastrarFunc('', '','', '', $conexao);
                                print_r($usuarios = $CadastrarUsuario->recuperar(''));
                            ...
                            <div class="input-group mt-3 col-12">
                                <input name="pdf" type="file"  class="form-control" id="inputGroupFile01">
                            </div>
                        </div>
